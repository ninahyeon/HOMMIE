...
<body>
	<div class="container">
		...
		<!-- 방내놓기 -->
		<section class="FWrap">
			<form name="uploadFlat" action="submit_uploadF" method="POST"
				...
				<div class="uploadF">
					...
					<div class="flatDo">
						<ul class="titUL">
							<li><a class="flatupload"> 방 내놓기 </a></li>
							...
							<tr>
								...
								<td class="bLine">
									<div class="switch-field">
										...
										<label for="flatType1">원룸</label> <input type="radio"
											id="flatType2" name="room" value="투룸"> <label
											for="flatType2">투룸</label> <input type="radio" id="flatType3"
											name="room" value="쓰리룸"> <label for="flatType3">쓰리룸</label>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="switch-field">
										...
										<label for="deal1" onclick="onChk('M', 'onChk')">월세</label> <input
											type="radio" id="deal2" name="rentType" value="전세"> <label
											for="deal2" onclick="onChk('R', 'onChk')">전세</label>
									</div>
									<div id="onChk" style="display: none;">
										...
										<div id="moneyy">
											<input class="input_box" type="text" placeholder="보증금"
												id="depo" name="deposit"> <span>만원 /</span> <input
												class="input_box" type="text" placeholder="월세(관리비 포함)"
												id="mon" name="rent"> <span>만원</span>
										</div>
									</div>
								</td>
							</tr>
					...
					<div class="infoF whereF">
						...
						<table>
							<tr>
								...
								<td class="bLine">
									<div class="inputAddress">
										...
										<div id="showAdrs" class="showAdrs"></div>
										<input name="deArds" id="detailedAdr" class="detailedAdr"
											type="text" placeholder="상세주소"> <input type="hidden"
											id="lat" name="lat"> <input type="hidden" id="lng"
											name="lng"> <input type="hidden" id="roadAdrs"
											name="roadAdrs"> <input type="hidden" id="jibunAdrs"
											name="jibunAdrs">
									</div>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<div class="kakaoMap">
										<div id="noticeL" class="noticeL" style="display: block;">
											<i class="fa fa-map-marker fa-2x" aria-hidden="true"></i>
											<p>
												주소를 검색하시면<br> 해당 위치가 지도에 표시됩니다.
											</p>
										</div>
						...
						<script>
							...
							function daumPostcode() {
								new daum.Postcode({
									...
									// 주소 정보를 해당 필드에 넣는다.
									document.getElementById("adrsSch").value = data.query;
										...
										geocoder.addressSearch(
											data.address, function(results, status) {
												// 정상적으로 검색이 완료됐으면
												if (status === daum.maps.services.Status.OK) {
													...
													$('#lat').val(result.y);
													$('#lng').val(result.x);
													$('#roadAdrs').val(data.roadAddress);
													$('#jibunAdrs').val(data.jibunAddress);
													document.getElementById("noticeL").style.display = "none";
							...
							<tr>
								...
								<td>
									<div class="switch-field">
										...
										<span class="selMoveD" id="selMoveD"></span> <input
											type="hidden" name="moveDate" id="moveDate">
									</div>
								</td>
							</tr>
						</table>
							...
							<tr>
								...
								<td class="bLine">
									<div class="switch-field">
										...
										<label for="park1">가능</label> <input type="radio" id="park2"
											name="park" value="N" checked> <label for="park2">불가능</label>
									</div>
								</td>
								<th class="bLine">반려동물</th>
								<td class="bLine">
									<div class="switch-field">
										<input type="radio" id="pet1" name="pet" value="Y"> <label
											for="pet1">가능</label> <input type="radio" id="pet2"
											name="pet" value="N" checked> <label for="pet2">불가능</label>
									</div>
								</td>
							</tr>
							<tr>
								...
								<td>
									<div class="switch-field">
										...
										<label for="internet1">설치</label> <input type="radio"
											id="internet2" name="internet" value="N" checked> <label
								...
								<td>
									<div class="switch-field">
										...
										<label for="furniture1">있음</label> <input type="radio"
											id="furniture2" name="furniture" value="N" checked> <label
											for="furniture2">없음</label>
									</div>
								</td>
							</tr>
						</table>
						...
						<table>
							<tr>
								...
								<td class="bLine"><input id="detTitle"
									...
									placeholder="예)신세계 도보 10분거리, 혼자 살기 좋은 방 입니다." name="title"></td>
							</tr>
							<tr>
								<th>상세 설명</th>
					...
					<div class="allDone">
						...
						<div>
							<input class="btn btn-outline-secondary" type="button" value="취소"
								...
								class="btn btn-primary" type="submit" value="매물등록">
						</div>
					</div>
