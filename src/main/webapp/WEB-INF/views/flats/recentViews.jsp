						...
						<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
							...
							<li class="nav-item dropdown"><a
								...
								<ul class="dropdown-menu big-item"
									...
									<li><a class="dropdown-item" href="#">최근 본 방</a></li>
								</ul></li>
							<c:choose>
		...
		<section class="FWrap">
			<form action="#" method="POST">
				<div class="uploadF">
					...
					<div class="flatDo">
						<ul class="titUL">
							<li style="border-bottom: 3px solid #d1d1d1;"><a
								href="dipsF" class="flatupload" style="color: #d1d1d1;"> 찜한
									목록 </a></li>
							<li onclick="" style="border-bottom: 3px solid #222;"><a
								href="#" class="myflat" style="color: #222;"> 최근 본 방 </a></li>
						</ul>
					</div>
					<div class="recentF">
						<input type="hidden" id="nowID"
							<c:if test="${logID!=null }">value="${logID }"</c:if>>
						<ul id="recentelyViewAll" class="keysch">
						</ul>
					</div>
